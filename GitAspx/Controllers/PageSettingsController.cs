...
namespace GitAspx.Controllers
{
    public class PageSettingsController : Controller
    {
        ...
        {
            PageSettings loSettings = Session["PageSettings"] as PageSettings;
            if (loSettings == null)
                Session["PageSettings"] = loSettings = new PageSettings();
            PropertyInfo loProp = typeof(PageSettings).GetProperty(key);
            if (loProp != null)
            {
